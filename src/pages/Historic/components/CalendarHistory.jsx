...
export default function CalendarHistory({ historyByDay, onSelectDay }) {
  ...
  return (
    <div className="calendar-wrapper premium-card">
      <LocalizationProvider dateAdapter={AdapterDayjs}>
        <DateCalendar
          onChange={(d) => onSelectDay(d.format("YYYY-MM-DD"))}
          slots={{
            day: (props) => {
              ...
              return (
                <PickersDay
                  {...props}
                  sx={{
                    bgcolor: rarity ? rarityColors[rarity] : undefined,
